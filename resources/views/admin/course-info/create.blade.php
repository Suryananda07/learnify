...
@section('content')
    <div x-data="{ topics: [{ title: '', content: '' }], questions: [{ question: '', options: ['', '', '', ''], correct: null }] }" class="flex flex-col">
        ...
        <form method="POST" action="{{ route('courses.store') }}" enctype="multipart/form-data"
            ...
            <textarea name="description" id="" rows="10" placeholder="Enter description course"
                class="w-full px-4 py-2.5 rounded-[10px] border text-sm outline-none transition-all duration-300 border-gray-300 bg-white focus:border-primary focus:ring-2 focus:ring-primary/20"></textarea>
            ...
            <x-input name="image" type="file" :required="true" />
